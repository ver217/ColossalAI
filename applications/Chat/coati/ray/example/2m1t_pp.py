...
from coati.ray.src.experience_maker_holder import ExperienceMakerHolder, ExperienceMakerHolderVoid
...
def main(args):
    ...
    experience_holder_1_ref = ExperienceMakerHolder.options(name="maker1", num_gpus=1, max_concurrency=2).remote(
        ...
        # maker2: maker1's employee
    experience_holder_2_ref = ExperienceMakerHolderVoid.options(name="maker2", num_gpus=1, max_concurrency=2).remote(
        strategy=args.maker_strategy,
