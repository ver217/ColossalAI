    ...
    do
        ...
        do
            ...
            do
                ...
                echo running: ${num_trainers}_${num_makers}_pretrain_${pretrain##*/}_experience_batch_size_${experience_batch_size}_train_batch_size_${train_batch_size}_update_steps_${update_steps}_experience_steps_${experience_steps}
                ...
                nohup python mmmt_prompt.py \
                    ...
                    --debug > logs/output_${num_trainers}_${num_makers}_pretrain_${pretrain##*/}_experience_batch_size_${experience_batch_size}_train_batch_size_${train_batch_size}_update_steps_${update_steps}_experience_steps_${experience_steps}.txt 2>&1
            done
        done
    done
done